...
import { OneMarketingSegmentResponseDto } from './dto/marketing-segment-response.dto';
...
export class MarketingSegmentsController {
  ...
  @ApiOperation({
    ...
    description:
      "Creates a new marketing segment for the authenticated user's merchant. Only portal administrators and merchant administrators can create marketing segments.",
  })
  @ApiCreatedResponse({
  ...
  @ApiForbiddenResponse({
    description:
      'Forbidden - You must be associated with a merchant to create marketing segments',
    type: ErrorResponse,
  })
  @ApiNotFoundResponse({
  ...
  @ApiOperation({
    ...
    description:
      "Retrieves a paginated list of marketing segments for the authenticated user's merchant. Supports filtering by type, name, and creation date.",
  })
  @ApiQuery({
    name: 'page',
    required: false,
  ...
  @ApiForbiddenResponse({
    description:
      'Forbidden - User must be associated with a merchant to view marketing segments',
    type: ErrorResponse,
  })
  @ApiBadRequestResponse({
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves a specific marketing segment by its ID. Users can only access marketing segments from their own merchant.',
  })
  ...
  @ApiForbiddenResponse({
    description:
      'Forbidden - You can only view marketing segments from your own merchant',
    type: ErrorResponse,
  })
  @ApiNotFoundResponse({
  ...
  @ApiBadRequestResponse({
    description: 'Invalid marketing segment ID',
    type: ErrorResponse,
  })
  async findOne(
  ...
  @ApiOperation({
    ...
    description:
      "Updates an existing marketing segment for the authenticated user's merchant. Only portal administrators and merchant administrators can update marketing segments. All fields are optional.",
  })
  @ApiParam({
    name: 'id',
    type: Number,
  ...
  @ApiForbiddenResponse({
    description:
      'Forbidden - You can only update marketing segments from your own merchant',
    type: ErrorResponse,
  })
  @ApiNotFoundResponse({
    description: 'Marketing segment not found',
  ...
  @ApiOperation({
    ...
    description:
      'Performs a soft delete by changing the marketing segment status to "deleted". Only merchant administrators can delete marketing segments from their own merchant.',
  })
  @ApiParam({
    name: 'id',
    type: Number,
    description: 'Marketing segment ID to delete',
  })
  @ApiOkResponse({
  ...
  @ApiForbiddenResponse({
    description:
      'Forbidden - You can only delete marketing segments from your own merchant',
    type: ErrorResponse,
  })
  @ApiNotFoundResponse({
    description: 'Marketing segment not found',
  ...
  @ApiConflictResponse({
    description: 'Marketing segment is already deleted',
    type: ErrorResponse,
  })
  async remove(
    @Param('id', ParseIntPipe) id: number,
