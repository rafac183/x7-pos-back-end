...
@RequireFeature(SUBSCRIPTION_FEATURE_IDS.MARKETING_AUTOMATION_ACTION)
@UseGuards(JwtAuthGuard, RolesGuard, FeatureAccessGuard)
export class MarketingAutomationActionsController {
  constructor(
    private readonly marketingAutomationActionsService: MarketingAutomationActionsService,
  ) {}
  ...
  @ApiOperation({
    ...
    description:
      "Creates a new marketing automation action for the authenticated user's merchant. Only portal administrators and merchant administrators can create marketing automation actions.",
  })
  @ApiCreatedResponse({
  ...
  @ApiForbiddenResponse({
    description:
      'Forbidden - You must be associated with a merchant to create marketing automation actions',
    type: ErrorResponse,
  })
  @ApiNotFoundResponse({
  ...
  async create(
    ...
    return this.marketingAutomationActionsService.create(
      dto,
  ...
  @ApiOperation({
    ...
    description:
      "Retrieves a paginated list of marketing automation actions for the authenticated user's merchant. Supports filtering by automation ID, action type, target ID, and creation date.",
  })
  @ApiQuery({
    name: 'page',
    required: false,
  ...
  @ApiOkResponse({
    description:
      'Paginated list of marketing automation actions retrieved successfully',
  ...
  @ApiForbiddenResponse({
    description:
      'Forbidden - User must be associated with a merchant to view marketing automation actions',
    type: ErrorResponse,
  })
  @ApiBadRequestResponse({
  ...
  async findAll(
    ...
    const authenticatedUserMerchantId = this.merchantIdOf(req);
    return this.marketingAutomationActionsService.findAll(
      query,
      authenticatedUserMerchantId,
    );
  }
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves a specific marketing automation action by its ID. Users can only access marketing automation actions from their own merchant.',
  })
  @ApiParam({
    name: 'id',
    type: Number,
    description: 'Marketing automation action ID',
  })
  @ApiOkResponse({
  ...
  @ApiForbiddenResponse({
    description:
      'Forbidden - You can only view marketing automation actions from your own merchant',
    type: ErrorResponse,
  })
  @ApiNotFoundResponse({
  ...
  @ApiBadRequestResponse({
    description: 'Invalid marketing automation action ID',
    type: ErrorResponse,
  })
  async findOne(
    ...
    const authenticatedUserMerchantId = this.merchantIdOf(req);
    return this.marketingAutomationActionsService.findOne(
      id,
      authenticatedUserMerchantId,
    );
  }
  ...
  @ApiOperation({
    ...
    description:
      "Updates an existing marketing automation action for the authenticated user's merchant. Only portal administrators and merchant administrators can update marketing automation actions. All fields are optional.",
  })
  @ApiParam({
    name: 'id',
    type: Number,
  ...
  @ApiForbiddenResponse({
    description:
      'Forbidden - You can only update marketing automation actions from your own merchant',
    type: ErrorResponse,
  })
  @ApiNotFoundResponse({
    description: 'Marketing automation action not found',
  ...
  @ApiBody({
    ...
    description:
      'Marketing automation action update data (all fields optional)',
    examples: {
      example1: {
  ...
  async update(
    ...
    const authenticatedUserMerchantId = this.merchantIdOf(req);
    return this.marketingAutomationActionsService.update(
      id,
      dto,
      authenticatedUserMerchantId,
    );
  ...
  @ApiOperation({
    ...
    description:
      'Performs a soft delete by changing the marketing automation action status to "deleted". Only merchant administrators can delete marketing automation actions from their own merchant.',
  })
  @ApiParam({
    name: 'id',
    type: Number,
    description: 'Marketing automation action ID to delete',
  })
  @ApiOkResponse({
  ...
  @ApiForbiddenResponse({
    description:
      'Forbidden - You can only delete marketing automation actions from your own merchant',
    type: ErrorResponse,
  })
  @ApiNotFoundResponse({
    description: 'Marketing automation action not found',
  ...
  @ApiConflictResponse({
    description: 'Marketing automation action is already deleted',
    type: ErrorResponse,
  })
  async remove(
    @Param('id', ParseIntPipe) id: number,
    ...
    const authenticatedUserMerchantId = this.merchantIdOf(req);
    return this.marketingAutomationActionsService.remove(
      id,
      authenticatedUserMerchantId,
    );
  }
