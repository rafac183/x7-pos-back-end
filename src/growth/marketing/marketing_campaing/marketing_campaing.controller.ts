...
import { OneMarketingCampaignResponseDto } from './dto/marketing-campaign-response.dto';
...
export class MarketingCampaignController {
  ...
  @ApiOperation({
    ...
    description:
      "Creates a new marketing campaign for the authenticated user's merchant. Only portal administrators and merchant administrators can create marketing campaigns.",
  })
  @ApiCreatedResponse({
  ...
  @ApiForbiddenResponse({
    description:
      'Forbidden - You must be associated with a merchant to create marketing campaigns',
    type: ErrorResponse,
  })
  @ApiNotFoundResponse({
  ...
  async create(
    ...
    return this.marketingCampaignService.create(
      dto,
  ...
  @ApiOperation({
    ...
    description:
      "Retrieves a paginated list of marketing campaigns for the authenticated user's merchant. Supports filtering by channel, status, name, and creation date.",
  })
  @ApiQuery({
    name: 'page',
    required: false,
  ...
  @ApiForbiddenResponse({
    description:
      'Forbidden - User must be associated with a merchant to view marketing campaigns',
    type: ErrorResponse,
  })
  @ApiBadRequestResponse({
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves a specific marketing campaign by its ID. Users can only access marketing campaigns from their own merchant.',
  })
  ...
  @ApiForbiddenResponse({
    description:
      'Forbidden - You can only view marketing campaigns from your own merchant',
    type: ErrorResponse,
  })
  @ApiNotFoundResponse({
  ...
  @ApiBadRequestResponse({
    description: 'Invalid marketing campaign ID',
    type: ErrorResponse,
  })
  async findOne(
    ...
    const authenticatedUserMerchantId = this.merchantIdOf(req);
    return this.marketingCampaignService.findOne(
      id,
      authenticatedUserMerchantId,
    );
  }
  ...
  @ApiOperation({
    ...
    description:
      "Updates an existing marketing campaign for the authenticated user's merchant. Only portal administrators and merchant administrators can update marketing campaigns. All fields are optional.",
  })
  @ApiParam({
    name: 'id',
    type: Number,
  ...
  @ApiForbiddenResponse({
    description:
      'Forbidden - You can only update marketing campaigns from your own merchant',
    type: ErrorResponse,
  })
  @ApiNotFoundResponse({
    description: 'Marketing campaign not found',
  ...
  async update(
    ...
    const authenticatedUserMerchantId = this.merchantIdOf(req);
    return this.marketingCampaignService.update(
      id,
      dto,
      authenticatedUserMerchantId,
    );
  ...
  @ApiOperation({
    ...
    description:
      'Performs a soft delete by changing the marketing campaign status to "deleted". Only merchant administrators can delete marketing campaigns from their own merchant.',
  })
  @ApiParam({
    name: 'id',
    type: Number,
    description: 'Marketing campaign ID to delete',
  })
  @ApiOkResponse({
  ...
  @ApiForbiddenResponse({
    description:
      'Forbidden - You can only delete marketing campaigns from your own merchant',
    type: ErrorResponse,
  })
  @ApiNotFoundResponse({
    description: 'Marketing campaign not found',
  ...
  @ApiConflictResponse({
    description: 'Marketing campaign is already deleted',
    type: ErrorResponse,
  })
  async remove(
    @Param('id', ParseIntPipe) id: number,
    ...
    const authenticatedUserMerchantId = this.merchantIdOf(req);
    return this.marketingCampaignService.remove(
      id,
      authenticatedUserMerchantId,
    );
  }
