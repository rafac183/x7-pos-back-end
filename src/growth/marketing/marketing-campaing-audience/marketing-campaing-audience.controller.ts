...
import { OneMarketingCampaignAudienceResponseDto } from './dto/marketing-campaign-audience-response.dto';
...
export class MarketingCampaingAudienceController {
  constructor(
    private readonly marketingCampaingAudienceService: MarketingCampaingAudienceService,
  ) {}
  ...
  @ApiOperation({
    ...
    description:
      'Creates a new audience entry linking a customer to a marketing campaign. Only portal administrators and merchant administrators can create audience entries.',
  })
  @ApiCreatedResponse({
  ...
  @ApiForbiddenResponse({
    description:
      'Forbidden - You must be associated with a merchant to create audience entries',
    type: ErrorResponse,
  })
  @ApiNotFoundResponse({
  ...
  async create(
    ...
    return this.marketingCampaingAudienceService.create(
      dto,
  ...
  @ApiOperation({
    summary:
      'Get all Marketing Campaign Audience entries with pagination and filters',
    description:
      "Retrieves a paginated list of marketing campaign audience entries for the authenticated user's merchant. Supports filtering by campaign, customer, status, and creation date.",
  })
  @ApiQuery({
    name: 'page',
    required: false,
  ...
  @ApiOkResponse({
    description:
      'Paginated list of marketing campaign audience entries retrieved successfully',
  ...
  @ApiForbiddenResponse({
    description:
      'Forbidden - User must be associated with a merchant to view audience entries',
    type: ErrorResponse,
  })
  @ApiBadRequestResponse({
  ...
  async findAll(
    ...
    const authenticatedUserMerchantId = this.merchantIdOf(req);
    return this.marketingCampaingAudienceService.findAll(
      query,
      authenticatedUserMerchantId,
    );
  }
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves a specific marketing campaign audience entry by its ID. Users can only access audience entries from their own merchant.',
  })
  @ApiParam({
    name: 'id',
    type: Number,
    description: 'Marketing campaign audience entry ID',
  })
  @ApiOkResponse({
  ...
  @ApiForbiddenResponse({
    description:
      'Forbidden - You can only view audience entries from your own merchant',
    type: ErrorResponse,
  })
  @ApiNotFoundResponse({
    description: 'Marketing campaign audience entry not found',
    type: ErrorResponse,
  })
  @ApiBadRequestResponse({
    description: 'Invalid audience entry ID',
    type: ErrorResponse,
  })
  async findOne(
    ...
    const authenticatedUserMerchantId = this.merchantIdOf(req);
    return this.marketingCampaingAudienceService.findOne(
      id,
      authenticatedUserMerchantId,
    );
  }
  ...
  @ApiOperation({
    ...
    description:
      "Updates an existing marketing campaign audience entry for the authenticated user's merchant. Only portal administrators and merchant administrators can update audience entries. All fields are optional.",
  })
  @ApiParam({
    name: 'id',
    type: Number,
  ...
  @ApiForbiddenResponse({
    description:
      'Forbidden - You can only update audience entries from your own merchant',
    type: ErrorResponse,
  })
  @ApiNotFoundResponse({
    description:
      'Marketing campaign audience entry, campaign, or customer not found',
    type: ErrorResponse,
  })
  @ApiBadRequestResponse({
  ...
  @ApiBody({
    ...
    description:
      'Marketing campaign audience update data (all fields optional)',
    examples: {
      example1: {
  ...
  async update(
    ...
    const authenticatedUserMerchantId = this.merchantIdOf(req);
    return this.marketingCampaingAudienceService.update(
      id,
      dto,
      authenticatedUserMerchantId,
    );
  ...
  @ApiOperation({
    ...
    description:
      'Performs a soft delete by changing the audience entry status to "deleted". Only merchant administrators can delete audience entries from their own merchant.',
  })
  @ApiParam({
    name: 'id',
    type: Number,
    description: 'Marketing campaign audience entry ID to delete',
  })
  @ApiOkResponse({
  ...
  @ApiForbiddenResponse({
    description:
      'Forbidden - You can only delete audience entries from your own merchant',
    type: ErrorResponse,
  })
  @ApiNotFoundResponse({
    description: 'Marketing campaign audience entry not found',
  ...
  @ApiConflictResponse({
    description: 'Marketing campaign audience entry is already deleted',
    type: ErrorResponse,
  })
  async remove(
    @Param('id', ParseIntPipe) id: number,
    ...
    const authenticatedUserMerchantId = this.merchantIdOf(req);
    return this.marketingCampaingAudienceService.remove(
      id,
      authenticatedUserMerchantId,
    );
  }
